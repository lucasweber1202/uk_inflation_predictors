...
### metadata
One row per series. Required fields include `series_id`, `source_id`, name, description, country, currency, frequency, unit, first/last observation, observation count, `eco_group`, source URL, last publish date and collected timestamp.
